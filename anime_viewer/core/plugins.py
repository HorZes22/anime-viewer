# -*- coding: utf-8 -*-
"""
Плагины: Plugin, PluginAction, PluginContext, PluginManager.
...
__all__ = ['LoadedPlugin', 'Plugin', 'PluginAction', 'PluginContext', 'PluginManager', 'PluginStore', 'load_plugin_sources']
